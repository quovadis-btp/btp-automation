...
locals {
  ...
  administrators_merge = merge(var.cluster_admins, [ data.tfe_outputs.current-runtime-context.values.user_plan, data.tfe_outputs.current-runtime-context.values.user_apply ] )
}
